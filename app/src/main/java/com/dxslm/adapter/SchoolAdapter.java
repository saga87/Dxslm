...
public class SchoolAdapter extends BaseQuickAdapter<SchoolList.ListBean , BaseViewHolder> {
    ...
    public SchoolAdapter(List data) {
        super(R.layout.item_news, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, SchoolList.ListBean item) {
        imgs.clear();
        helper.setText(R.id.item_tv_news_title, item.getInfo_title());
        helper.setText(R.id.n_news_contact, item.getInfo_content().trim());
