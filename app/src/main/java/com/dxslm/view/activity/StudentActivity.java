...
import com.dxslm.adapter.StudentAdapter;
...
public class StudentActivity extends BaseActivity {
    ...
    @Bind(R.id.iv_student_back)
    ImageView ivStudentBack;
    @Bind(R.id.iv_student_ddd)
    ImageView ivStudentDdd;
    @Bind(R.id.recyclerview_student)
    RecyclerView recyclerview;
    @Bind(R.id.refresh_student)
    ...
    private void getData() {
        ...
        HeadModel.getInstance().studentList(page, pagesize, deptId, roleId, new ICallBack() {
            public void succeed(Object object) {
                StudentList list = (StudentList) object;
    ...
    public void setRecyclerAdapter(List<StudentList.ListBean> list) {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                List<StudentList.ListBean> list = adapter.getData();
...
//        HeadModel.getInstance().schoolList(page, pagesize, deptId, roleId, new ICallBack() {
    ...
    @OnClick({R.id.iv_student_back, R.id.iv_student_ddd})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_student_back:
                finish();
                break;
            case R.id.iv_student_ddd:
                break;
        }
    }
}
