...
public class UsedAdapter extends BaseQuickAdapter<UsedList.ListBean , BaseViewHolder> {
    private final String deptId;
    private final String roleId;
    private final String userId;
    private boolean isVisibility = true;
    private UsedCommentList user;
    private UsedCommentAdapter adapter;
    ...
    public UsedAdapter(List data, Context context) {
    ...
    @Override
    protected void convert(final BaseViewHolder helper, final UsedList.ListBean item) {
//        GlideUtil.getIconBitmap(UrlUtil.URL+item.getHeadpic(), (ImageView) helper.getView(R.id.item_civ_love_icon));
        ...
        helper.getView(R.id.item_ll_love_comment).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (lv.getVisibility()==View.GONE){
                    ...
                    ActivityModel.getInstance().usedCommentList(item.getShi_id(), roleId, new ICallBack() {
                        @Override
                        public void succeed(Object object) {
                            user = (UsedCommentList) object;
                            adapter = new UsedCommentAdapter(mContext,user.getList());
        ...
        mFaceImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rl.getVisibility() == View.VISIBLE) {
                   // helper.getView(R.id.rl_face_contain).setVisibility(View.GONE);
                    rl.setVisibility(View.GONE);
                } else {
                   // helper.getView(R.id.rl_face_contain).setVisibility(View.VISIBLE);
        ...
        helper.getView(R.id.item_btn_love_confirm).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityModel.getInstance().usedComment(roleId, item.getShi_id(),comment,userId,"",item.getInput_user(), new ICallBack() {
                    @Override
                    public void succeed(Object object) {
        ...
        helper.getView(R.id.item_ll_love_dz).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ActivityModel.getInstance().usedDz(roleId, item.getShi_id(),userId, new ICallBack() {
                    @Override
                    public void succeed(Object object) {
                        Success success = (Success) object;
                        if(success.isSuccess()){
                            ...
                            ActivityModel.getInstance().usedDzNum(roleId, item.getShi_id(), new ICallBack() {
                                @Override
                                public void succeed(Object object) {
     ...
     * 更新评论
     */
    private void commentList(UsedList.ListBean item, final ListViewForScrollView lv, final BaseViewHolder helper) {
        ActivityModel.getInstance().usedCommentList(item.getShi_id(), roleId, new ICallBack() {
            @Override
            public void succeed(Object object) {
                user = (UsedCommentList) object;
