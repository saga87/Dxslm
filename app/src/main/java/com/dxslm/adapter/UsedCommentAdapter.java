 ...
 */
public class UsedCommentAdapter extends BaseAdapter {

    private Context mContext;
    private List<UsedCommentList.ListBean> mItemList;
    private LayoutInflater mInflater;
    private CommentDialog dialog;
    private Success success;
    private UsedCommentList commentList;
    private  final String roleId;
    private  final String userId;
    public UsedCommentAdapter(Context context, List<UsedCommentList.ListBean> itemList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final UsedCommentList.ListBean item = mItemList.get(position);
        ...
        //  viewHolder.tv_item_comment_contect.setText(item.getShr_content());
        parseMessage(item.getShr_content(),viewHolder.tv_item_comment_contect);
                ...
                dialog = new CommentDialog(mContext, item.getUsername(),
                        new DialogCallback() {
                            ...
                            public void succeed(Object object) {
                                ...
                                if(!object.equals("")){
                                    String bbrUset = item.getShr_user();
                                    ActivityModel.getInstance().usedComment(roleId, item.getShi_id() ,str ,userId ,bbrUset,bbrUset , new ICallBack() {
                                        @Override
                                        public void succeed(Object object) {
                                            ...
                                            if(success.isSuccess()){
                                                ActivityModel.getInstance().usedCommentList(item.getShi_id(), roleId, new ICallBack() {
                                                    public void succeed(Object object) {
                                                        commentList = (UsedCommentList) object;
        ...
        viewHolder.circleImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userId.equals(item.getShr_user())){
                    Intent intent = new Intent(mContext, PersonNewsActivity.class);
                    intent.putExtra("userId",item.getShr_user());
...
//            Log.e("399", group);
    ...
    public void refreshData(List<UsedCommentList.ListBean> itemList) {
    ...
    public void addData(List<UsedCommentList.ListBean> itemList) {
        mItemList.addAll(itemList);
        notifyDataSetChanged();
    }
